...
<h1 class="text-center my-3">No News found.</h1>
</div>
@else
<div class="col-md-8 grid-sidebar" id="content">
    <div class="jl_cat_mid_title">
        <h3 class="categories-title title text-center">KẾT QUẢ TÌM KIẾM</h3>
    </div>
    <div class="jl_wrapper_cat">
        ...
        @endphp
                <div
                    ...
                    <div class="jl_grid_w">
                        <div class="jl_img_box jl_radus_e"> <a href="{{route('detail', $item->id)}}"> <span class="jl_post_type_icon"><i
                                        class="jli-quote-2"></i></span>
                        ...
                        <div class="text-box">
                            <h3><a href="#" tabindex="-1">{{ $item->title}}</a></h3> <span class="jl_post_meta"><span class="jl_author_img_w"><i
